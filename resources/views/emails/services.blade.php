...
<html lang="en-US">
	...
	<body style="font-family:sans-serif;background:#fff">
		<h2 style="color:#c71444;">Service Enquiry from the McCarthy Nissan website</h2>
		<br>
		...
		<div>
			<table width="100%">
				...
				<tr>
					<td style="padding:10px;background:#ebebeb;width:15%"><b>Work required:</b></td>
					<td style="padding:10px;background:#f7f7f7">{{ $work_required }}</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="padding:10px;background:#ebebeb;width:15%"><b>Odometer:</b></td>
					<td style="padding:10px;background:#f7f7f7">{{ $odometer }}</td>
				</tr>				
				<tr>
					<td style="padding:10px;background:#ebebeb;width:100%" colspan="2"><b>Preferences</b></td>
				</tr>
				<tr>
					<td style="padding:10px;background:#ebebeb;width:15%"><b>Service date:</b></td>
					<td style="padding:10px;background:#f7f7f7">{{ $service_date }}</td>
				</tr>
				<tr>

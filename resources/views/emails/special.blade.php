...
<html lang="en-US">
	...
	<body style="font-family:sans-serif;background:#fff">
		<h2 style="color:#c71444;">Special Enquiry from the McCarthy Nissan website</h2>
		<br>
		<b>Dealership: </b>: {{ $dealership }}<br><br>
		<div style="font-family:sans-serif;background:#fff">
			<table width="100%">
				<tr>
					<td style="font-family:sans-serif;padding:10px;background:#ebebeb;width:15%"><b>Special:</b></td>
					<td style="font-family:sans-serif;padding:10px;background:#f7f7f7"><b>{{ $special }}</b></td>
				</tr>
				<tr>

	...
	<nav class="navbar yamm navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">				
				<a class="navbar-brand active"  href="/">McCarthy Nissan</a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="/">Home</a></li>					
					<li><a href="/new-cars">New Cars</a></li>
					<li><a href="{{ URL::route('pages.demos') }}">Demo Cars</a></li>
					<li><a href="{{ URL::route('pages.pre-owned-cars') }}">Pre-owned Cars</a></li>
					
					<li><a href="{{ URL::route('pages.specials') }}">Specials</a></li>
					<li><a href="{{ URL::route('pages.service') }}">Service</a></li>
					<li><a href="{{ URL::route('pages.parts') }}">Parts</a></li>
					<li><a href="{{ URL::route('pages.why') }}">Why McCarthy</a></li>
					<li><a href="{{ URL::route('pages.contact') }}">Contact</a></li>

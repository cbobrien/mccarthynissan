...
@section('content')
	...
	<div class="copy-container">
		<div class="container">
			<h1 class="page-heading">Parts <span class="small">&amp;</span> Accessories</h1>		
				<div class="form-container">			
					<div class="row">
						...
						{!! Form::open(['route' => 'parts.send', 'class' => '', 'id' => 'form']) !!}				
							...
							<div class="col-xs-12 col-md-4">																						
								<fieldset>
									...
									<div class="form-group">
										<label for="parts_info" class="required-label">Parts' name/number/description</label>
										{!! Form::textarea('parts_info', null, ['class' => 'form-control', 'id' => 'parts_info', 'required']) !!}
									</div>
								</fieldset>						 											  
							</div>
							<div class="col-xs-12 col-md-4">
		...
		$('#form').submit(function(e) {			
			...
			$.ajax({
	            ...
	            data: {
	            	...
	            	year: $('#form #year').val(),
	            	parts_info: $('#form #parts_info').val(),

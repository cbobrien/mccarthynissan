						...
						<div class="row">
							<div class="car-row">
								<div class="col-xs-12 col-sm-4 used-car-image-container">
									<a href="/view-car/preowned/{{ $car->vid }}"><img src="{{ (trim($car->img1) != '') ? $car->img1 : '/images/unavailable.png' }}" class="img-responsive {{ (trim($car->img1) == '') ? 'hidden-xs' : '' }}" alt=""></a>
								</div>
											...
											<div class="col-xs-12 col-sm-6">
												<p class="text-right used-buttons"> 										
													<a href="#" class="btn btn-red left-top-radius border-grey" 
															...
															data-enquiry-type="preowned">Enquire</a>

													<a href="/view-car/preowned/{{ $car->vid }}" class="btn btn-grey right-bottom-radius view-hover border-grey">View</a>
												</p>
											</div>
										</div>																													
									</div>
